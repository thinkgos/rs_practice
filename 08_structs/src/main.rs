...
fn main() {
    ...
    // user1.email = String::from("anotheremail@example.com"); // 错误! 因为不可变

    // 打印结构体, 需要实现trait `Debug`, 可以加注解`#[derive(Debug)]`
    println!("\t{:#?}", user1);
