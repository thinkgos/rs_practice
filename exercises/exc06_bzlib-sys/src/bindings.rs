...
fn bindgen_test_layout_bz_stream() {
    const UNINIT: ::std::mem::MaybeUninit<bz_stream> = ::std::mem::MaybeUninit::uninit();
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).total_in_lo32) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(bz_stream),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).total_in_hi32) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(bz_stream),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).total_out_lo32) as usize - ptr as usize },
        36usize,
        concat!(
            "Offset of field: ",
            stringify!(bz_stream),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).total_out_hi32) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(bz_stream),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).bzalloc) as usize - ptr as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(bz_stream),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).bzfree) as usize - ptr as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(bz_stream),
